...
public class OOItems {
    ...
    public static final RegistryObject<Item> ONION_RINGS = HELPER.createItem("onion_rings", () ->
            new Item(new Item.Properties().food((new FoodProperties.Builder()).nutrition(2).saturationMod(0.7F).build())));
    ...
    public static void buildCreativeTabContents() {
        CreativeModeTabContentsPopulator.mod(OnionOnion.MOD_ID)
                .tab(CreativeModeTabs.FOOD_AND_DRINKS)
                .addItemsAfter(of(Items.RABBIT_STEW), ONION_SLICE, ONION_RINGS, MOTLEY_GRILL, MOTLEY_GRILL_BLOCK);
    }
}
