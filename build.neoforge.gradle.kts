...
dependencies {
    ...
    implementation("com.davigj:framechanger:3.0.0") {
        isTransitive = false
    }
    implementation("com.teamabnormals:blueprint:1.21.1-8.0.4")
    // EMI - Farmer's Delight has direct integration.
    runtimeOnly("dev.emi:emi-neoforge:${property("deps.emi")}")
    compileOnly("maven.modrinth:overweight-farming:9w8TG5JN")
}
